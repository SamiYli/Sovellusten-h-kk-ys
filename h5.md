...
## LAB0
Purin lab0.zip ja sieltä löytyi "buggy_program" ohjelma ja "buggy_program.c" sekä "Makefile"-tiedosto.
### Avasin GDB:ssä "buggy_program ja katsoin miltä se näyttää.
Listataan ohjelman koodia komennolla:
 ```
l
 ```
![l buggy_program](buggy_program_gdb_l.JPG)

### Kun ajetaan buggy_program
Tulosteessa viimeisenä elementtinä tulee mitä sattuu.


![](buggy_program_gdb_run.JPG)


### Korjataan muuttamalla lähdekoodia
Kopioin vanhan lähdekoodin NotBuggy_program nimiseksi tiedostoksi ja muutin sitä micro koodieditorissa.


![micro NotBuggy](NotBuggy.JPG)

Lähdekoodi sitten käännetään binääriksi: 
 ```
gcc -g NotBuggy.c -o NotBuggy
 ```

### Testi

![Testi NotBuggy](run_NotBuggy.JPG)
